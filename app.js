...
window.onload = function () {
    initConfig();
    DemoStore.init();
    if (!heroMotionStarted) initHeroCanvas();
    initHeaderScroll();
...
function openCheckout() {
    ...
    if (hint) hint.classList.toggle('hidden', !ClientAccounts.isLoggedIn());
...
let canvas, ctx, points = [], mouse = { x: null, y: null }, heroMotionStarted = false;
